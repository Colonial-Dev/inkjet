...
; note: the above four statements match overzealously,
; and so are placed at the end of the file.

(keyw) @keyword
; more specific matches are done above whenever possible

; the following statements have not been dealt with (some may need to be, others may not)
; varTuple
; subrangeDecl
; tupleDesc
; pragmaStmt
