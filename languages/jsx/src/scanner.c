...
unsigned tree_sitter_jsx_external_scanner_serialize(void *payload, char *buffer) { return 0; }
...
bool tree_sitter_jsx_external_scanner_scan(void *payload, TSLexer *lexer, const bool *valid_symbols) {
